...
\begin{figure}[!t]
  \centering
  \begin{tikzpicture}[]
    \node[] at (-4.5, 0){\includegraphics[scale=0.2,angle=90]{\FILEPATH/signal-epilepsy.png}};
    \node[align=left] at (-4.2, 0) {$x_i$};
    \draw[dashed,->] (-4, 0) -- (-3.8, 0);
    \node[draw, minimum height=2.55cm] at (-3.5, 0) {$m$};
    \draw[dashed,->] (-3.2, 0) -- (-3, 0);
    \node[] at (-1.7, 0){\includegraphics[scale=0.41,angle=90]{\FILEPATH/cnn-epilepsy.png}};
...
\begin{figure*}[!t]
  \centering
  \rotatebox[origin=l]{90}{\small Original Signal}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.2]{\FILEPATH/signal-eyes-open.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.2]{\FILEPATH/signal-eyes-closed.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.2]{\FILEPATH/signal-healthy-area.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.2]{\FILEPATH/signal-tumor-area.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.2]{\FILEPATH/signal-epilepsy.png}
  \end{subfigure}

  \rotatebox[origin=l]{90}{\small `Signal as Image'}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/signal-as-image-eyes-open.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/signal-as-image-eyes-closed.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/signal-as-image-healthy-area.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/signal-as-image-tumor-area.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/signal-as-image-epilepsy.png}
  \end{subfigure}

  \rotatebox[origin=l]{90}{\small \hspace{1mm} Spectrogram}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/spectrogram-eyes-open.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/spectrogram-eyes-closed.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/spectrogram-healthy-area.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/spectrogram-tumor-area.png}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/spectrogram-epilepsy.png}
  \end{subfigure}

  \rotatebox[origin=l]{90}{\small \hspace{5mm} one layer CNN}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/cnn-eyes-open.png}
    \caption{Open}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/cnn-eyes-closed.png}
    \caption{Closed}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/cnn-healthy-area.png}
    \caption{Healthy}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/cnn-tumor-area.png}
    \caption{Tumor}
  \end{subfigure}
  \begin{subfigure}{0.19\linewidth}
    \centering
    \includegraphics[scale=0.5]{\FILEPATH/cnn-epilepsy.png}
    \caption{Epilepsy}
  \end{subfigure}
