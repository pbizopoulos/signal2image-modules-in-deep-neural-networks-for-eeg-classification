...
\begin{figure}[!t]
	\centering
	\begin{tikzpicture}[]
		\node[] at (-4.5, 0){\includegraphics[scale=0.2,angle=90]{results/signal-epilepsy}};
		\node[align=left] at (-4.2, 0) {$x_i$};
		\draw[dashed,->] (-4, 0) -- (-3.8, 0);
		\node[draw, minimum height=2.55cm] at (-3.5, 0) {$m$};
		\draw[dashed,->] (-3.2, 0) -- (-3, 0);
		\node[] at (-1.7, 0){\includegraphics[scale=0.41,angle=90]{results/cnn-epilepsy}};
...
\begin{figure*}[!t]
	...
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal-eyes-open}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal-eyes-closed}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal-healthy-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal-tumor-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal-epilepsy}
	\end{subfigure}

	\rotatebox[origin=c]{90}{`Signal as Image'}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal-as-image-eyes-open}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal-as-image-eyes-closed}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal-as-image-healthy-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal-as-image-tumor-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal-as-image-epilepsy}
	\end{subfigure}

	\rotatebox[origin=c]{90}{Spectrogram}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram-eyes-open}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram-eyes-closed}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram-healthy-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram-tumor-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram-epilepsy}
	\end{subfigure}

	\rotatebox[origin=c]{90}{\hspace{5mm} one layer CNN}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn-eyes-open}
		\caption{Open}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn-eyes-closed}
		\caption{Closed}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn-healthy-area}
		\caption{Healthy}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn-tumor-area}
		\caption{Tumor}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn-epilepsy}
		\caption{Epilepsy}
	\end{subfigure}
