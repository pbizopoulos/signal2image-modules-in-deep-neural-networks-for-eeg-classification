...
\begin{figure}[!t]
	\centering
	\begin{tikzpicture}[]
		\node[] at (-4.5, 0){\includegraphics[scale=0.2,angle=90]{results/signal_epilepsy.png}};
		\node[align=left] at (-4.2, 0) {$x_i$};
		\draw[dashed,->] (-4, 0) -- (-3.8, 0);
		\node[draw, minimum height=2.55cm] at (-3.5, 0) {$m$};
		\draw[dashed,->] (-3.2, 0) -- (-3, 0);
		\node[] at (-1.7, 0){\includegraphics[scale=0.41,angle=90]{results/cnn_epilepsy.png}};
	...
	The names of the labels are depicted at the right along with the predictions for this example signal.
	...
	For the 1D architectures $m$ is omitted and no intermediate image is generated.}
	\label{fig:highleveloverview}
\end{figure}

\section{METHODS}
\subsection{Definitions}
We define the dataset $D=\{x_i, y_i\}_{i=1...N}$ where $x_i \in \mathbb{Z}^n$ and $y_i \in \{1, 2, 3, 4, 5\}$ denote the $i^{th}$ input signal with dimensionality $n=178$ and the $i^{th}$ label with five possible classes respectively.
...
\begin{figure*}[!t]
	...
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal_eyes_open.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal_eyes_closed.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal_healthy_area.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal_tumor_area.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{results/signal_epilepsy.png}
	\end{subfigure}

	\rotatebox[origin=c]{90}{`Signal as Image'}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal_as_image_eyes_open.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal_as_image_eyes_closed.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal_as_image_healthy_area.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal_as_image_tumor_area.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/signal_as_image_epilepsy.png}
	\end{subfigure}

	\rotatebox[origin=c]{90}{Spectrogram}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram_eyes_open.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram_eyes_closed.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram_healthy_area.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram_tumor_area.png}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/spectrogram_epilepsy.png}
	\end{subfigure}

	\rotatebox[origin=c]{90}{\hspace{5mm} one layer CNN}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn_eyes_open.png}
		\caption{Open}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn_eyes_closed.png}
		\caption{Closed}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn_healthy_area.png}
		\caption{Healthy}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn_tumor_area.png}
		\caption{Tumor}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{results/cnn_epilepsy.png}
		\caption{Epilepsy}
	\end{subfigure}
