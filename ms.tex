...
\begin{figure}[!t]
	\centering
	\begin{tikzpicture}[]
		\node[] at (-4.5, 0){\includegraphics[scale=0.2,angle=90]{tmp/signal-epilepsy}};
		\node[align=left] at (-4.2, 0) {$x_i$};
		\draw[dashed,->] (-4, 0) -- (-3.8, 0);
		\node[draw, minimum height=2.55cm] at (-3.5, 0) {$m$};
		\draw[dashed,->] (-3.2, 0) -- (-3, 0);
		\node[] at (-1.7, 0){\includegraphics[scale=0.41,angle=90]{tmp/cnn-epilepsy}};
...
\begin{figure*}[!t]
	...
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{tmp/signal-eyes-open}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{tmp/signal-eyes-closed}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{tmp/signal-healthy-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{tmp/signal-tumor-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.2]{tmp/signal-epilepsy}
	\end{subfigure}

	\rotatebox[origin=c]{90}{`Signal as Image'}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/signal-as-image-eyes-open}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/signal-as-image-eyes-closed}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/signal-as-image-healthy-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/signal-as-image-tumor-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/signal-as-image-epilepsy}
	\end{subfigure}

	\rotatebox[origin=c]{90}{Spectrogram}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/spectrogram-eyes-open}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/spectrogram-eyes-closed}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/spectrogram-healthy-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/spectrogram-tumor-area}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/spectrogram-epilepsy}
	\end{subfigure}

	\rotatebox[origin=c]{90}{\hspace{5mm} one layer CNN}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/cnn-eyes-open}
		\caption{Open}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/cnn-eyes-closed}
		\caption{Closed}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/cnn-healthy-area}
		\caption{Healthy}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/cnn-tumor-area}
		\caption{Tumor}
	\end{subfigure}
	\begin{subfigure}{0.19\linewidth}
		\centering
		\includegraphics[scale=0.5]{tmp/cnn-epilepsy}
		\caption{Epilepsy}
	\end{subfigure}
