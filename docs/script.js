...
async function loadModel(predictFunction) {
	...
	model = await loadModelFunction(
		"https://raw.githubusercontent.com/pbizopoulos/signal2image-modules-in-deep-neural-networks-for-eeg-classification/main/latex/python/dist/resnet34-1D/model.json",
		{
			onProgress: (fraction) => {
