...
tmp/check-done: .gitignore README
	...
	if ls -ap | grep -v -E -x './|../|.deploy.sh|.deploy-requirements.sh|.env|.git/|.github/|.gitignore|CITATION|LICENSE|Makefile|README|docs/|latex/|python/|tmp/' | grep -q .; then false; fi
